        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {(language === 'nl' ? content.intro.featuresNl : content.intro.featuresEn).map((feature, idx) => (
              <div key={idx} className="flex items-start gap-3 p-4 bg-card/50 backdrop-blur-sm rounded-lg border border-[#2a3439] hover:border-[#8eb564] transition-colors">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <div className="space-y-4">
            {(language === 'nl' ? content.method.phasesNl : content.method.phasesEn).map((phase, idx) => (
              <div key={idx} className="border-2 border-[#2a3439] rounded-lg overflow-hidden hover:border-[#8eb564] transition-colors">
                <button
                ...
                {expandedSection === `phase-${idx}` && (
                  <div className="bg-card/30 backdrop-blur-sm p-6 border-t-2 border-[#2a3439]">
          ...
          <div className="bg-card/50 backdrop-blur-sm rounded-lg p-8 border-2 border-[#8eb564] mb-8">
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              {(language === 'nl' ? content.timeline.phasesNl : content.timeline.phasesEn).map((item, idx) => (
                <div key={idx} className="flex items-center justify-between p-4 bg-[#2a3439]/50 rounded-lg border border-[#2a3439]">
            ...
            <div className="bg-[#2a3439]/50 p-6 rounded-lg border-2 border-[#8eb564]">
