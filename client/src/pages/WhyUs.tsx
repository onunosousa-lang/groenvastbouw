...
export default function WhyUs() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5EF] font-sans">
      ...
      <section className="py-24 bg-[#F5F5EF]">
        <div className="container mx-auto px-4 max-w-4xl">
          
          {/* 1. ECONOMIC INCENTIVE */}
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-4 bg-[#F5F5EF] rounded-xl text-[#8edb38]"><TrendingUp size={32} /></div>
              <div>
            ...
            <div className="prose prose-lg text-[#2a3439] leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-8 my-10">
                <Card className="bg-[#F5F5EF] border-none shadow-md hover:shadow-lg transition-shadow">
          ...
          <hr className="border-[#F5F5EF] my-16" />

          {/* 2. TECHNICAL SUPERIORITY */}
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-4 bg-[#F5F5EF] rounded-xl text-[#2a3439]"><Factory size={32} /></div>
              <div>
            ...
            <div className="prose prose-lg text-[#2a3439] leading-relaxed">
              ...
              <ul className="space-y-6 list-none pl-0 mt-8">
                <li className="flex gap-5 items-start">
                  <div className="mt-1 p-2 bg-[#F5F5EF] rounded-lg"><Ruler className="text-[#2a3439]" size={20} /></div>
                  <div>
                ...
                <li className="flex gap-5 items-start">
                  <div className="mt-1 p-2 bg-[#F5F5EF] rounded-lg"><Zap className="text-[#2a3439]" size={20} /></div>
                  <div>
                ...
                <li className="flex gap-5 items-start">
                  <div className="mt-1 p-2 bg-[#F5F5EF] rounded-lg"><ShieldCheck className="text-[#2a3439]" size={20} /></div>
                  <div>
          ...
          <div className="mb-20">
            ...
            <div className="bg-card p-10 rounded-2xl text-[#2a3439] mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-[#F5F5EF] p-6 rounded-lg border border-[#8edb38]/20">
            ...
            <div className="bg-[#F5F5EF] border-l-4 border-[#8edb38] p-6 rounded-r-lg">
          ...
          <div className="mb-10">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-4 bg-[#F5F5EF] rounded-xl text-[#8edb38]"><Leaf size={32} /></div>
              <div>
            ...
            <div className="bg-[#F5F5EF] p-10 rounded-2xl border border-[#F5F5EF] shadow-inner">
               ...
               <p className="text-[#2a3439] mb-6 text-lg leading-relaxed">
                 {language === 'nl'
                   ? 'De bouwsector is verantwoordelijk voor 39% van de wereldwijde CO₂-uitstoot. Onze methode draait dit om. Elk huis slaat ongeveer 20 ton CO₂ op in de houtstructuur. Onze partnerfabriek in Portugal gebruikt uitsluitend FSC-gecertificeerd hout en streeft naar een volledig carbon-negatieve productieketen.'
                   : 'The construction sector is responsible for 39% of global CO₂ emissions. Our method reverses this. Each house stores approximately 20 tons of CO₂ in its timber structure. Our partner factory in Portugal uses only FSC-certified wood and strives for a fully carbon-negative production chain.'}
               </p>
               <div className="grid md:grid-cols-3 gap-6">
                 <div className="bg-[#F5F5EF] p-4 rounded-lg">
      ...
      <section className="py-20 bg-gradient-to-r from-[#8edb38] to-[#8edb38] text-[#2a3439]">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-xl mb-10 text-[#F5F5EF]">
            {language === 'nl'
              ? 'Neem vandaag nog contact op voor een vrijblijvend gesprek en ontdek hoe het Groenvastbouw engineered timber system, geproduceerd met industriële precisie in Portugal, uw project kan transformeren.'
              : 'Contact us today for a no-obligation consultation and discover how the Groenvastbouw engineered timber system, manufactured with industrial precision in Portugal, can transform your project.'}
          </p>
          <a 
            href="#contact" 
            className="inline-block bg-[#F5F5EF] text-[#8edb38] px-10 py-4 rounded-lg text-lg font-bold hover:bg-[#F5F5EF] transition-colors shadow-lg"
          >
