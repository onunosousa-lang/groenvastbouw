...
export default function WhyUs() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 text-[#8eb564] hover:text-[#8eb564] font-semibold text-lg group"
              >
      ...
      {/* Call to Action */}
      <section className="py-20 bg-gradient-to-r from-[#8eb564] to-[#8eb564] text-foreground">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-xl mb-10 text-[#f0f7e8]">
            {language === 'nl' 
              ? <>Neem vandaag nog contact op voor een vrijblijvend gesprek en ontdek hoe Groenvastbouw en <a href="https://www.senmar.pt" target="_blank" rel="noopener noreferrer" className="text-[#8eb564] hover:text-[#8eb564] font-semibold">Senmar</a> uw project kunnen transformeren.</>
              : <>Contact us today for a no-obligation consultation and discover how Groenvastbouw and <a href="https://www.senmar.pt" target="_blank" rel="noopener noreferrer" className="text-[#8eb564] hover:text-[#8eb564] font-semibold">Senmar</a> can transform your project.</>}
          </p>
          <a 
            href="#contact" 
