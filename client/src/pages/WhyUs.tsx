          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div>
              ...
              <h2 className="text-4xl font-bold text-[#2a3439] mb-6">
                {language === 'nl' ? <>Groenvastbouw × <a href="https://www.senmar.pt" target="_blank" rel="noopener noreferrer" className="text-[#8edb38] hover:text-[#8edb38]">Senmar</a></> : <>Groenvastbouw × <a href="https://www.senmar.pt" target="_blank" rel="noopener noreferrer" className="text-[#8edb38] hover:text-[#8edb38]">Senmar</a></>}
              </h2>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 text-[#8edb38] hover:text-[#8edb38] font-semibold text-lg group"
              >
