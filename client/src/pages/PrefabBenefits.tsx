...
export default function PrefabBenefits() {
  ...
  const benefits = [
    ...
    {
      icon: <PiggyBank className="w-10 h-10 text-green-600" />,
    ...
    {
      icon: <PenTool className="w-10 h-10 text-green-600" />,
    ...
    {
      icon: <VolumeX className="w-10 h-10 text-green-600" />,
      title: t('prefab_sound_title'),
      desc: t('prefab_sound_desc')
    },
    {
      icon: <HardHat className="w-10 h-10 text-green-600" />,
    ...
    {
      icon: <Feather className="w-10 h-10 text-green-600" />,
