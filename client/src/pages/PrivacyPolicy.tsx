    ...
    sections: language === 'nl' ? [
      {
        ...
        content: 'Groenvastbouw is een bedrijf dat hoogperformante geprefabriceerde timmerhuizen levert via het Groenvastbouw engineered timber system, geproduceerd met industriële precisie in Portugal. Wij zijn gevestigd in Nederland en zijn verantwoordelijk voor de verwerking van uw persoonsgegevens. Voor vragen over dit privacybeleid kunt u contact met ons opnemen via info@groenvastbouw.nl of telefonisch op +31 6 2984 1297.'
      },
      {
      ...
      {
        title: '1. Who are we?',
        content: 'Groenvastbouw is a company that delivers high-performance prefabricated timber houses via the Groenvastbouw engineered timber system, manufactured with industrial precision in Portugal. We are based in the Netherlands and are responsible for processing your personal data. For questions about this privacy policy, you can contact us at info@groenvastbouw.nl or by phone at +31 6 2984 1297.'
      },
      {
