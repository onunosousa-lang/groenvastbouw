    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: 'url(/houtbouw-constructie-arbeiders.jpg)' }}
        />
        {/* Overlay for Text Readability */}
        <div className="absolute inset-0 bg-gradient-to-br from-green-900/90 to-[#6fb820]/85" />
        {/* Content */}
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white">
            ...
            <p className="text-xl md:text-2xl text-[#f0f7e8] max-w-3xl mx-auto">
              {language === 'nl' 
        ...
        <div className="container mx-auto px-4">
          <Card className="overflow-hidden shadow-2xl">
            <div className="bg-gradient-to-r from-[#90dc35] to-[#6fb820] p-8 text-white">
              ...
              <p className="text-xl text-[#f0f7e8]">
                {language === 'nl' 
