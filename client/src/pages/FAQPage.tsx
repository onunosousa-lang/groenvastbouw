...
export default function FAQPage() {
  ...
  const content = {
    title: language === 'nl' ? <>FAQ – Passieve Huizen & <a href="https://www.senmar.pt" target="_blank" rel="noopener noreferrer" className="text-[#8eb564] hover:text-[#8eb564] font-bold">Senmar</a> Systeem</> : <>FAQ – Passive Houses & <a href="https://www.senmar.pt" target="_blank" rel="noopener noreferrer" className="text-[#8eb564] hover:text-[#8eb564] font-bold">Senmar</a> System</>,
    intro: language === 'nl' 
      ? <>Groenvastbouw biedt hoogwaardige houtskelet passieve huizen in samenwerking met het <a href="https://www.senmar.pt" target="_blank" rel="noopener noreferrer" className="text-[#8eb564] hover:text-[#8eb564] font-bold">Senmar</a> prefab systeem uit Portugal. Op deze pagina vindt u antwoorden op de meest gestelde vragen van particuliere klanten, ontwikkelaars en architecten.</>
      : <>Groenvastbouw offers high-performance timber frame passive houses in cooperation with the <a href="https://www.senmar.pt" target="_blank" rel="noopener noreferrer" className="text-[#8eb564] hover:text-[#8eb564] font-bold">Senmar</a> prefab system from Portugal. On this page you will find answers to the most common questions from private clients, developers and architects.</>,
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <a 
            href="/#contact" 
            className="inline-flex items-center justify-center gap-2 bg-[#8eb564] text-foreground px-6 py-3 rounded-full font-semibold hover:bg-[#8eb564] transition-colors"
          >
            <Mail size={20} />
            {content.contactUs}
          </a>
