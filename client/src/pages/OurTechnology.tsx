    ...
    <div className="min-h-screen bg-white font-sans text-[#2A3439]">
      ...
      <section className="pt-32 pb-16 px-4 bg-[#2A3439] text-white">
        <div className="max-w-6xl mx-auto mb-8">
          <Link href="/" className="inline-flex items-center text-[#7FB956] hover:text-white font-semibold transition-colors group">
            ...
            <table className="w-full bg-white rounded-xl shadow-lg overflow-hidden">
              <thead className="bg-[#2A3439] text-white">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left font-semibold text-[#7FB956]">{language === 'nl' ? 'Voordeel' : 'Advantage'}</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-semibold">{content.metric1Label}</td>
                  <td className="px-6 py-4 text-[#7FB956] font-bold">{content.metric1Passive}</td>
                  <td className="px-6 py-4 text-gray-600">{content.metric1Dutch}</td>
                  <td className="px-6 py-4 text-[#7FB956] font-bold">{content.metric1Ratio}</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-semibold">{content.metric2Label}</td>
                  <td className="px-6 py-4 text-[#7FB956] font-bold">{content.metric2Passive}</td>
                  <td className="px-6 py-4 text-gray-600">{content.metric2Dutch}</td>
                  <td className="px-6 py-4 text-[#7FB956] font-bold">{content.metric2Ratio}</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-semibold">{content.metric3Label}</td>
                  <td className="px-6 py-4 text-[#7FB956] font-bold">{content.metric3Passive}</td>
                  <td className="px-6 py-4 text-gray-600">{content.metric3Dutch}</td>
                  <td className="px-6 py-4 text-[#7FB956] font-bold">{content.metric3Ratio}</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-semibold">{content.metric4Label}</td>
                  <td className="px-6 py-4 text-[#7FB956] font-bold">{content.metric4Passive}</td>
                  <td className="px-6 py-4 text-gray-600">{content.metric4Dutch}</td>
                  <td className="px-6 py-4 text-[#7FB956] font-bold">{content.metric4Ratio}</td>
                </tr>
              </tbody>
            </table>
          </motion.div>
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-[#7FB956]/10 flex items-center justify-center">
                      <Icon className="text-[#7FB956]" size={24} />
                    </div>
                    <div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <h3 className="text-xl font-bold mb-3 text-[#7FB956]">{benefit.title}</h3>
      ...
      <section className="py-20 px-4 bg-[#2A3439] text-white">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div {...fadeInUp}>
            ...
            <Link href="/">
              <Button className="bg-[#7FB956] hover:bg-[#6fa844] text-white px-8 py-3 rounded-lg font-semibold text-lg">
