export const translations = {
  nl: {
    ...
    faq_energy_a: "Een Passivhaus verbruikt 60-90% minder energie dan een gemiddelde Nederlandse woning. Dit resulteert in aanzienlijke besparingen op energiekosten gedurende de levensduur van de woning.",
    ...
    prefab_subtitle: "Why Choose the Groenvastbouw engineered timber system?",
  ...
  en: {
    ...
    faq_energy_a: "A Passivhaus consumes 60-90% less energy than an average Dutch home. This results in significant savings on energy costs over the lifetime of the home.",
