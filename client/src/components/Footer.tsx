  ...
  return (
    <footer className="bg-[#dcdcdc] py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <p>
                <a href={`mailto:${currentContent.email}`} className="text-[#2a3439] hover:text-[#8edb38] transition-colors">
                  {currentContent.email}
                </a>
              </p>
              <p>
                <a href={`tel:${currentContent.phone}`} className="text-[#2a3439] hover:text-[#8edb38] transition-colors">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <p>
                <Link href="/privacy-policy" className="text-[#2a3439] hover:text-[#8edb38] transition-colors">
                  {currentContent.privacy}
                </Link>
              </p>
              <p>
                <Link href="/terms-of-service" className="text-[#2a3439] hover:text-[#8edb38] transition-colors">
        ...
        {/* Divider */}
        <div className="border-t border-[#2a3439] pt-8">
