...
export default function FeaturedProjects() {
  ...
  return (
    <section className="py-20 bg-[#dcdcdc] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
          ...
          <Link href="/projects">
            <a className="inline-flex items-center gap-2 px-6 py-3 bg-[#8edb38] text-[#2a3439] rounded-lg font-semibold hover:bg-[#7aa050] transition-colors whitespace-nowrap">
              {content.cta}
