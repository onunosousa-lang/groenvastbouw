      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto mt-12 space-y-4">
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-2">Basis Structuur</h3>
          ...
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-2">Optimale Structuur</h3>
          ...
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-2">Passieve Structuur</h3>
