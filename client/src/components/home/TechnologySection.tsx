        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4">
                <div className="bg-[#f0f7e8] p-3 rounded-lg">
                  <Factory className="text-[#8eb564]" size={24} />
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="bg-[#f0f7e8] p-3 rounded-lg">
                  <Ruler className="text-[#8eb564]" size={24} />
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="bg-[#f0f7e8] p-3 rounded-lg">
                  <Award className="text-[#8eb564]" size={24} />
                </div>
                <div>
            ...
            <a href="https://www.senmar.pt" target="_blank" rel="noopener noreferrer">
              <Button variant="outline" className="gap-2 border-[#8eb564] text-[#8eb564] hover:bg-green-50">
