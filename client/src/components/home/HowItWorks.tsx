...
export default function HowItWorks() {
  ...
  return (
    <section id={language === 'nl' ? 'proces' : 'process'} className="py-20 bg-white scroll-mt-20">
            ...
            >
              {(activeTab === 'structure' ? content.structureSteps : content.turnkeySteps).map((step, index) => (
                <div key={index} className="relative group">
                  ...
                  <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow h-full flex flex-col items-center text-center relative z-10">
