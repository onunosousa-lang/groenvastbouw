        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-12">
          ...
          >
              ...
              <ul className="space-y-2.5 mb-8">
                {content.b2b.points.map((point, index) => (
                  <li key={index} className="flex items-start gap-3 text-[#2a3439] text-sm">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#8eb564] flex-shrink-0" />
                    <span>{point}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="p-8 bg-gray-50 border-t border-gray-200">
              <Button 
                onClick={openModal}
                className="w-full bg-[#8eb564] hover:bg-[#8eb564] text-[#2a3439] h-12 text-base font-semibold group"
              >
                {content.b2b.cta}
          ...
          >
            ...
            <div className="p-8 bg-gray-50 border-t border-gray-200">
              <a 
                ...
                className="w-full"
              >
                <Button className="w-full bg-[#8eb564] hover:bg-[#8eb564] text-[#2a3439] h-12 text-base font-semibold group shadow-lg hover:shadow-[0_0_30px_rgba(144,220,53,0.5)] transition-all duration-300 hover:scale-105">
                  {content.prefab.cta}
